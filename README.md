...
* [PageGuard](https://pageguard.org) - Free website health scanner providing automated SEO audit, performance analysis, accessibility compliance (WCAG 2.1), and AI-powered action plans. No login required, instant scan (~30 seconds). Open source (MIT): https://github.com/sleepyxpad-jpg/pageguard `MIT` `Open Source`
