...
* [Foxmetrics](http://www.foxmetrics.com/) - analytics to track your user’s actions and activities.
...
* [Clicky](https://clicky.com/) - track visits and conversions, you can also track your video and audio analytics.
* [Woopra](https://www.woopra.com/) - track where your users are coming from.
* [Mint](http://haveamint.com/) - elf-hosted analytics solution. 
* [Going Up](https://goingup.com/) - manage SEO analytics and web app analytics with one tool.
...
* [Adobe Digital Analytics](http://www.adobe.com/marketing-cloud/web-analytics/marketing-analytics-capabilities.html) - standard analytics tools plus some that large organizations can use.
...
* [Mouseflow](https://mouseflow.com/) - live analytics and heatmaps.
* [Session Cam](https://sessioncam.com/) - heatmaps analytics tool.
...
* [Keen.io](https://www.adjust.com/) - custom-analytics API.
* [Popcorn metrics](http://www.popcornmetrics.com/) - visual editor to capture events and send to toher platforns.
* [Segment.io](https://segment.com/) - helps you integrate multiple app analytics tool with one piece of code.
...
* [Appsflyer](https://www.appsflyer.com/) - all-in-one marketing tool with analytics.
...
* [Roambi](http://roambi.com/) - 3-in-1 analytics tool that helps you track analytics, handle mobile app business intelligence, and app reporting.
* [Appcelerator](http://www.appcelerator.com/product/) - entire mobile app marketing suite.
* [Flurry](http://www.flurry.com/) - pretty much the “industry standard” for mobile app analytics.
* [Count.ly](https://count.ly/) - open-source mobile app analytics tool.
...
* [Appsee](https://www.appsee.com/) - mobile app analytics platform automatically tracks all users' interactions in your app
...
* [Appfigures](https://appfigures.com/) - app store analytics to track sales, reviews and rankings with an API.
* [Appannie](https://www.appannie.com/) - track your app data from iTunes, Google Play & Amazon.
* [Distimo](http://www.distimo.com/) - free app store analytics (acquired by [Appannie](https://www.appannie.com/)).
* [Priori Data](https://prioridata.com/) - track and benchmark the performance of apps on Apple- and Play store.
* [Asking Point](https://www.askingpoint.com/mobile-app-rating-widget/) - track your mobile app user ratings.
* [Apptrace](http://www.apptrace.com/) - fast and free app store analytics platform.

## Attribution tracking

* [Adjust](https://www.adjust.com/) - open-source SDK with sophisticated analysis and campaign tracking.
* [Clickmeter](http://clickmeter.com/) - analytics tool that helps you track marketing campaigns.
* [HasOffers Mobile app tracking](http://www.tune.com/) - attribution analytics platform.
...
* [Falconsocial](https://www.falconsocial.com/) - communications platform built on social media with analytics.
* [Quintly](https://www.quintly.com/) - web-based tool to help you track, benchmark and optimize your social media performance.
* [Kred](http://home.kred/) - Klout-like social media analytics platform.
* [Buffer](https://buffer.com/) - Social media publishing and analytics platform.
...
* [Brandwatch](https://www.brandwatch.com/) - Social media monitoring and analytics.
