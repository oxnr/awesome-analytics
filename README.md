...
* [Talivia](https://talivia.com) - Revenue-first web and product analytics with traffic attribution, funnels, events, session replay, Web Vitals, and payment integrations. Also available as an open-source self-hosted alternative to DataFast. ([Source Code](https://github.com/talivia-group/talivia)) `MIT` `Self-Hosted` `TypeScript`
