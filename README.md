...
* [AI for Database](https://aifordatabase.com) - Agentic AI for databases — query any database in plain English, build self-refreshing dashboards, and trigger automated workflows based on data changes. No SQL required. `©` `SaaS`
