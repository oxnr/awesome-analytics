...
* [Swetrix](https://swetrix.com/) - A powerful cookie-free analytics platform that respects user privacy, ([Source Code](https://github.com/swetrix)) `MIT`/`AGPL-3.0` `NodeJS`
